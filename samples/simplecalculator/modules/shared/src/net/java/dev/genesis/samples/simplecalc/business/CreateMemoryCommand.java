...
public class CreateMemoryCommand extends AbstractHibernateCommand {

   /**
    * @Transactional
    */
   public CalculatorMemory createMemory(final CalculatorMemory memory) throws Exception {
      getSession().save(memory);
      return memory;
   }
}
