...
public class RestoreMemoryCommand extends AbstractHibernateCommand {

   /**
    * @Remotable
    */
   public CalculatorMemory getMemory(String id) throws Exception {
    return (CalculatorMemory)getSession().load(CalculatorMemory.class,id);  
   }
}