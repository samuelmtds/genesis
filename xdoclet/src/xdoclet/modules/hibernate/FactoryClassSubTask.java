...
public class FactoryClassSubTask extends TemplateSubTask implements HibernateProperties
{
    ...
    {
        throw new UnsupportedOperationException("FactoryCllassSubTask does not have a jndiProperties attribute.");
    }

    public String getTransactionManagerStrategy()
    {
        throw new UnsupportedOperationException("FactoryCllassSubTask does not have a Driver attribute.");
    }
    ...
    protected void engineStarted() throws XDocletException
    {
        System.out.println(Translator.getString(XDocletModulesHibernateMessages.class,
            XDocletModulesHibernateMessages.GENERATING_HIBERNATE_FACTORY_CLASS));
    }
}