...
public class ScriptFormatterAdapter implements Formatter {
   private final ScriptExpression expression;
   private final FormController controller;

   public ScriptFormatterAdapter(ScriptExpression expr, FormController controller) {
   ...
   public String format(Object o) {
      ...
      return FormatterRegistry.getInstance().format(expression.eval(controller.getScriptContext()));
   }
}
