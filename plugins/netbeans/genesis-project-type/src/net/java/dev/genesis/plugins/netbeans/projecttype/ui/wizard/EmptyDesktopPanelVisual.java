...
public class EmptyDesktopPanelVisual extends JPanel implements DocumentListener {
    
    public static final String PROP_PROJECT_NAME = "projectName";
    
    private EmptyDesktopWizardPanel panel;
    private int type;
    
    /** Creates new form PanelProjectLocationVisual */
    public EmptyDesktopPanelVisual(EmptyDesktopWizardPanel panel) {
        initComponents();
        this.panel = panel;
        this.type = type;
